...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BL] = KEYMAP(
		...
		MO(_ML), KC_LGUI, KC_LALT, CTL_T(KC_BSPC), MO(_FL), LT(_FL, KC_SPC),  KC_RALT, KC_RGUI, KC_RCTL, MO(_CL)),

	[_FL] = KEYMAP(
		_______,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_PSCR,  _______, 
		_______, _______, _______, _______, _______, _______, KC_WBAK, KC_WFWD, _______, _______, KC_PAUS, _______, _______, KC_DEL, 
